...
class EmailEmbedder:
    ...
    def save_embeddings(self, embeddings: Dict[str, np.ndarray], file_path: str = 'data/embeddings.pkl') -> None:
        """
    ...
    def load_embeddings(self, file_path: str = 'data/embeddings.pkl') -> Dict[str, np.ndarray]:
        """
